...
| :-- | :-- |:---------|
| core | イベントトラッキング機能を提供します。 | 2.31.1   |
...
### Core 2.31.1
** 💊FIXED **
- JSONRequestクラスのコンストラクタに非互換な変更が含まれていたのを修正しました。

# Releases - 2025.07.15

### InAppFrame 0.5.1
** 🔨CHANGED**
- LegacyViewにおいて、InAppFrameを非表示にする際に、View削除ではなくVisibilityを変更するようにしました(NullPointerExceptionの回避のため)
