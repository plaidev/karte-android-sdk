...
internal enum class HookTargetMethodFromDynamicInvoke(private val className: String, private val methodName: String) {
    ...
    internal companion object {
        fun from(stackTraceElement: StackTraceElement): HookTargetMethodFromDynamicInvoke? = values()
            .firstOrNull {
