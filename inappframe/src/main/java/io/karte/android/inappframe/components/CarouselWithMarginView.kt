...
internal class CarouselWithMarginView private constructor(context: Context) :
    ...
    internal constructor(context: Context, carouselWithMargin: CarouselWithMarginV1, tracker: IAFTracker) : this(
        context
    ) {
        data = carouselWithMargin
        this.tracker = tracker
        binding.carouselWithMarginCarousel.setAdapter(
        ...
        motionLayoutView.viewTreeObserver.addOnGlobalLayoutListener(object : ViewTreeObserver.OnGlobalLayoutListener {
            ...
            override fun onGlobalLayout() {
                ...
                val layoutWidth = dpToPx(
                    context,
                    (
                        data.content.config.bannerHeight *
                            (data.content.config.ratio / 100.0)
                        ).toInt()
                )
                    ...
                    imageViewIds.forEachIndexed { _, imageViewId ->
                        ...
                        if (constraintSetId == R.id.carousel_with_margin_base_state) {
                            if (imageViewId == R.id.carousel_with_margin_imageView0 ||
                                imageViewId == R.id.carousel_with_margin_imageView1
                            ) {
                                constraintSet.setMargin(imageViewId, ConstraintSet.END, spacingInPixels)
                            }
                            if (imageViewId == R.id.carousel_with_margin_imageView3 ||
                                imageViewId == R.id.carousel_with_margin_imageView4
                            ) {
                            ...
                            if (imageViewId == R.id.carousel_with_margin_imageView0 ||
                                imageViewId == R.id.carousel_with_margin_imageView1 ||
                                imageViewId == R.id.carousel_with_margin_imageView2
                            ) {
                                constraintSet.setMargin(imageViewId, ConstraintSet.END, spacingInPixels)
                            }
                            ...
                            if (imageViewId == R.id.carousel_with_margin_imageView2 ||
                                imageViewId == R.id.carousel_with_margin_imageView3 ||
                                imageViewId == R.id.carousel_with_margin_imageView4
                            ) {
                                constraintSet.setMargin(imageViewId, ConstraintSet.START, spacingInPixels)
                            }
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        val layoutWidth =
            dpToPx(context, (data.content.config.bannerHeight * (data.content.config.ratio / 100.0)).toInt())
        val spacingInPixels = dpToPx(context, data.content.config.spacing)
        ...
        binding.carouselWithMarginGuideline.layoutParams =
            (binding.carouselWithMarginGuideline.layoutParams as LayoutParams).apply {
                guideBegin = guidelineConstraint
            }

        binding.carouselWithMarginGuideline2.layoutParams =
            (binding.carouselWithMarginGuideline2.layoutParams as LayoutParams).apply {
