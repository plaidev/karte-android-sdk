...
import io.karte.android.inappmessaging.internal.view.TouchVisualizerWindowView

private const val LOG_TAG = "Karte.IAMView"

@SuppressLint("ViewConstructor")
@TargetApi(Build.VERSION_CODES.KITKAT)
internal class TouchVisualizerIAMWindow(val activity: Activity, panelWindowManager: PanelWindowManager) : TouchVisualizerWindowView(activity, panelWindowManager) {
